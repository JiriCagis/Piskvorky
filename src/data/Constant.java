...
public class Constant {
    ...
    public static final String MENU_ITEM_MOVE_BACK = "Move back";
    public static final String MENU_ITEM_EXIT = "Exit game";

    public static final String MENU_THEME = "Theme";
    public static final String MENU_ITEM_DARK_THEME = "Dark";
    public static final String MENU_ITEM_BRIGHT_THEME = "Bright";
    public static final String MENU_ITEM_FESTIVAL_THEME = "Festival";

    public static final String MENU_HELP = "Help";
    public static final String MENU_ITEM_CONTROL_HELP = "Control game";
    public static final String MENU_ITEM_RULES = "Rules";
    public static final String MENU_ITEM_ABOUT_PROGRAM = "About program";
